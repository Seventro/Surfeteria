...
IL_0040:
	{
		...
		Action__ctor_mBDC7B0B4A3F583B64C2896F01BDED360772F67DC(L_18, (RuntimeObject*)__this, (intptr_t)((void*)il2cpp_rgctx_method(method->klass->rgctx_data, 22)), NULL);
		__this->___m_PerformDeferredScrollToItem = L_18;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___m_PerformDeferredScrollToItem), (void*)L_18);
		...
		NullCheck(L_20);
		VisualElement_set_disableClipping_m3E786643EBFEE5BDC0778C835140934FF3FF80CB(L_20, (bool)0, NULL);
		return;
	}
}
...
IL_0080:
	{
		...
		NullCheck(L_25);
		ObjectPool_1_Release_m71F1CADB7AD9CC20BD824583A3675A4260965DB5_inline(L_25, L_26, il2cpp_rgctx_method(method->klass->rgctx_data, 24));
		goto IL_015c;
	}
...
IL_00a9:
	...
	}
	{
		int32_t L_30 = V_2;
		int32_t L_31;
		L_31 = VerticalVirtualizationController_1_get_itemsCount_m41C7EC9F6A7BC1C8586B50841E845B6414F9801F(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 25));
...
IL_012b:
	{
		...
		int32_t L_48 = V_2;
		VerticalVirtualizationController_1_Setup_mC5415B4D4C6B65EB15FC1EB2EC4C85661E092CEA(__this, L_47, L_48, il2cpp_rgctx_method(method->klass->rgctx_data, 27));
	}
...
IL_0160:
	{
		...
		NullCheck(L_55);
		int32_t L_56;
		L_56 = List_1_get_Count_m4407E4C389F22B8CEC282C15D56516658746C383_inline(L_55, il2cpp_rgctx_method(method->klass->rgctx_data, 29));
	...
	}
	{
		...
		NullCheck(L_60);
		ObjectPool_1_Clear_m1AA2CCDA1BA91BB58C5A4578B03502A034811E4E(L_60, il2cpp_rgctx_method(method->klass->rgctx_data, 30));
		List_1_tA239CB83DE5615F348BB0507E45F490F4F7C9A8D* L_61 = __this->___m_ActiveItems;
		NullCheck(L_61);
		List_1_Clear_m16C1F2C61FED5955F10EB36BC1CB2DF34B128994_inline(L_61, il2cpp_rgctx_method(method->klass->rgctx_data, 31));
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* VerticalVirtualizationController_1_GetOrMakeItemAtIndex_m73EFFD0367510D9487186D58ECBBFEC9BC9C70AC_gshared (VerticalVirtualizationController_1_t9E15DCA430B4BA0FF230AC5A5E026167325EA345* __this, int32_t ___0_activeItemIndex, int32_t ___1_scrollViewIndex, const RuntimeMethod* method) 
{
	...
	RuntimeObject* V_4 = NULL;
	{
		...
		NullCheck(L_0);
		RuntimeObject* L_1;
		L_1 = ObjectPool_1_Get_m239BB169D8FEF3A2694E9A961C473D3807D67D89_inline(L_0, il2cpp_rgctx_method(method->klass->rgctx_data, 39));
		V_0 = L_1;
...
IL_0038:
	...
	}
	{
		...
		NullCheck(L_11);
		List_1_Add_mEBCF994CC3814631017F46A387B1A192ED6C85C7_inline(L_11, L_12, il2cpp_rgctx_method(method->klass->rgctx_data, 40));
		goto IL_006d;
	}
...
IL_005d:
	{
		...
		NullCheck(L_13);
		List_1_Insert_m9C9559248941FED50561DB029D55DF08DEF3B094(L_13, L_14, L_15, il2cpp_rgctx_method(method->klass->rgctx_data, 38));
	}
...
IL_0047:
	{
		...
		RuntimeObject* L_12 = V_0;
		NullCheck(L_11);
		ObjectPool_1_Release_m71F1CADB7AD9CC20BD824583A3675A4260965DB5_inline(L_11, L_12, il2cpp_rgctx_method(method->klass->rgctx_data, 24));
		List_1_tA239CB83DE5615F348BB0507E45F490F4F7C9A8D* L_13 = __this->___m_ActiveItems;
		RuntimeObject* L_14 = V_0;
		NullCheck(L_13);
		bool L_15;
		L_15 = List_1_Remove_m4DFA48F4CEB9169601E75FC28517C5C06EFA5AD7(L_13, L_14, il2cpp_rgctx_method(method->klass->rgctx_data, 41));
		return;
	}
}
