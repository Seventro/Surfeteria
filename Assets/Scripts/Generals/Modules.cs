...
public class Modules : MonoBehaviour {
    ...
    //xu ly gop cac scene
    public static GameObject containMainGame, containHeroConstruct, containAchievement, containShopItem, containHighScore, containOpenBox, login;
    ...
    public static bool RewardReborn()
    {
        bool result = false;
